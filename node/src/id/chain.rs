...
pub(crate) const MAINNET_C_CHAIN_ID: ChainId = ChainId(Id {
    inner: [
        4, 39, 212, 178, 42, 42, 120, 188, 221, 212, 86, 116, 44, 175, 145, 181, 107, 173, 191, 249, 133,
        238, 25, 174, 241, 69, 115, 231, 52, 63, 214, 82,
    ],
});
pub(crate) const FUJI_C_CHAIN_ID: ChainId = ChainId(Id {
    inner: [
        127, 201, 61, 133, 198, 214, 44, 91, 42, 192, 181, 25, 200, 112, 16, 234, 82, 148, 1, 45, 30, 64,
        112, 48, 214, 172, 208, 2, 28, 172, 16, 213,
    ],
});
